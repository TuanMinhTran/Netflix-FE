...
import {  faCheck, faEye, faEyeSlash, faLaptop, faMobileScreenButton, faTabletScreenButton, faTv  } from "@fortawesome/free-solid-svg-icons";
    ...
    return (
      <>
        <DefaultLayout>
            ...
            <div className={cx("wrapper", "reg-form")}>
              ...
              <form className={cx("form")}>
                <div className={cx("form-register")}>
                  ...
                  />
                  <label className={user.email ? cx("active") : ""}>
                    Email
                  </label>
                </div>
                {errors.email && (
                ...
                <div>
                  ...
                  Vui lòng không gửi các ưu đãi đặc biệt của Netflix qua email
                  cho tôi
                </div>
              </form>
              ...
              <div className={cx("plandGrid")}>
                  ...
                  <div className={cx("plandGrid-selector")}>
                    ...
                    >
                      <input
                        ...
                        value="plandChoice1"
                        className={cx("plandGrid-selector-input")}
                        id="plandGrid-choice1"
                        onChange={handleChangeOption}
                      />
                      <span
                        className={cx("plandGrid-selector-label", {
                          "plandGrid-selected-label":
                            optionPayment === "plandChoice1",
                        })}
                      >
                        Cơ bản
                      </span>
                    ...
                    >
                      <input
                        ...
                        value="plandChoice2"
                        className={cx("plandGrid-selector-input")}
                        id="plandGrid-choice2"
                        onChange={handleChangeOption}
                      />
                      <span
                        className={cx("plandGrid-selector-label", {
                          "plandGrid-selected-label":
                            optionPayment === "plandChoice2",
                        })}
                      >
                        Tiêu chuẩn
                      </span>
                    ...
                    >
                      <input
                        ...
                        value="plandChoice3"
                        className={cx("plandGrid-selector-input")}
                        id="plandGrid-choice3"
                        onChange={handleChangeOption}
                      />
                      <span
                        className={cx("plandGrid-selector-label", {
                          "plandGrid-selected-label":
                            optionPayment === "plandChoice3",
                        })}
                      >
                        Cao cấp
                      </span>
                    ...
                    <tr className={cx("plandGrid-feature-table-row")}>
                      ...
                      <td
                        className={cx("plandGrid-cell", {
                          selected: optionPayment === "plandChoice0",
                        })}
                      >
                        70.000 đ
                      </td>
                      <td
                        className={cx("plandGrid-cell", {
                          selected: optionPayment === "plandChoice1",
                        })}
                      >
                        108.000 ₫
                      </td>
                      <td
                        className={cx("plandGrid-cell", {
                          selected: optionPayment === "plandChoice2",
                        })}
                      >
                        220.000 ₫
                      </td>
                      <td
                        className={cx("plandGrid-cell", {
                          selected: optionPayment === "plandChoice3",
                        })}
                      >
                        260.000 ₫
                      </td>
                ...
                <div>
                  <small>
                    ...
                    <div></div>
                    <span>
                      Chỉ những người sống cùng bạn mới có thể dùng tài khoản
                      của bạn. Xem trên 4 thiết bị khác nhau cùng lúc với gói
                      Cao cấp, 2 với gói Tiêu chuẩn và 1 với gói Cơ bản và Di
                      động.
                    </span>
                  </small>
                </div>
          ...
          {(step === "paymentPicker" ||
            step === "creditOption" ||
            step === "mobileWalletOption") && (
            <Payment option={optionPayment} />
          )}
        </DefaultLayout>
      </>
    );
